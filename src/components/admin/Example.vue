<template>
	<div>
		...
		<button class="btn btn-danger" @click="renderAdminTable()">Rerender!</button>
				<!-- FORM  --> 
				<!-- EXAMPLE TEXT  --> 
	<div v-on:click="goExampleText(1)" class="mousepointer alert alert-primary mathFormulaText border-primary animated flipInY slow" v-html=example.pageContent ></div>
				<!-- EXAMPLE TEXT  --> 
				<!-- LIST  -->
